...
class PictureGallery1_GenerateController extends Q_Controller_Base
{
	...
	public function validateContentStructure($contentArray){
		...
		\Q\Utils::validateProperties(array(
			...
			'propertyList'=>array(
				...
				array('name'=>'panelImages', 'assertNotEmptyFlag'=>true),
				array('name'=>'parameterFiles', 'assertNotEmptyFlag'=>false),
				array('name'=>'templates', 'assertNotEmptyFlag'=>false),
			)));
